...
parser.add_argument("--save-model", default="infovae", type=str,
        help="The file containing already trained model.")
parser.add_argument("--save-image", default="infovae", type=str,
        help="The file containing already trained model.")
...
def loss_function(recon_xs, x, mu, logvar, categorical):
    ...
    KLD += args.lamb*torch.sum(c.mul(c.mul(model.cat_size).add_(1e-9).log()))
    return BCE + KLD
...
def train(epoch):
    ...
    for batch_idx, (data, _) in enumerate(train_loader):
        ...
        loss = loss_function(total_batch, data, mu, logvar, categorical)
